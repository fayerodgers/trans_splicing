...
${GIT_HOME}/trans_splicing/cluster_clips.sh  $DIR

echo "Plotting cluster sizes"
python ${GIT_HOME}/trans_splicing/parse_cdhit.py --clusters ${DIR}/candidate_clips.cdhit.clstr  --fasta ${DIR}/candidate_clips.cdhit --species $SPECIES | sort -nr -k2,2 > ${DIR}/cluster_summary.txt 
